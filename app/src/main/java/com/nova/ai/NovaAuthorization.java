...
public final class NovaAuthorization {
    ...
    public boolean isAllowed(String toolId){if(toolId==null||toolId.trim().isEmpty())return false;return toolId.equals("nova.echo")||toolId.equals("memory.append_context")||toolId.equals("memory.remember")||toolId.equals("memory.recall")||toolId.equals("memory.search")||toolId.equals("android.open_app")||toolId.equals("android.action")||toolId.equals("web.search")||toolId.equals("web.fetch")||toolId.equals("web.research")||toolId.equals("screen.observe")||toolId.equals("notification.recent")||toolId.equals("device.list")||toolId.equals("system.status")||toolId.equals("task.schedule")||toolId.equals("task.list")||toolId.equals("task.cancel_scheduled")||toolId.equals("device.send_command")||prefs.getBoolean("allow_"+toolId,false);}
